...
function ChatRooms() {
      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href="https://github.com/Vishal-Patel2"
              target="_blank"
  ...
  <div className="mb-12 rounded-2xl overflow-hidden shadow-md bg-gradient-to-r from-indigo-500 to-violet-600 text-white relative">
      ...
      <footer className="border-t border-gray-200 mt-10 sm:mt-12 py-6 px-4 text-center text-gray-600 text-sm sm:text-base">
        © 2025 <span className="font-semibold">OpenRoom</span>. Made with <span className="text-red-500">♥</span> for the community.
        ...
        >
          OpenRoom Team (Vishal)
        </a>{" "}
        — your simple and a real-time anonymous chat application Platform .
      </footer>
      </div>
    </div>
  );
